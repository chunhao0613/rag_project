...
專案的核心目標不在於單純實現 RAG 功能，而是展示完整的 **SRE (Site Reliability Engineering) 實踐能力**。透過標準化的 CI/CD 流程、Kubernetes 容器編排以及完整的監控告警機制，確保系統能夠穩定、安全且高效地迭代與運行。
